...
def createActionPage( version, action, value, neggs, nlessons, actdb ) :
    with open( version + "/" + action + ".md", "w") as f : 
         ...
         fixed_modules = ["adjmat", "envsim", "sprint", "clusters", "secondarystructure", "multicolvar", "valtools", "matrixtools", "colvar", "pamm", "volumes", "generic", "function", "wham", "core", "refdist", "fourier", "setup"]
